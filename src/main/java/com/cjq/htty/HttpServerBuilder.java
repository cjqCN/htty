...
public class HttpServerBuilder {
    ...
    private static final int DEFAULT_BOSS_THREAD_POOL_SIZE = AVAILABLE_PROCESSORS_NUM;
    private static final int DEFAULT_WORKER_THREAD_POOL_SIZE = AVAILABLE_PROCESSORS_NUM * 5;
    private static final int DEFAULT_ROUTER_HANDLER_THREAD_POOL_SIZE = AVAILABLE_PROCESSORS_NUM * 5;
    private static final int DEFAULT_EXEC_HANDLER_THREAD_POOL_SIZE = AVAILABLE_PROCESSORS_NUM * 15;
