...
/**
 * @description: Copy from Spring AntPathMatcher
 * @author: chenjinquan
 * @create: 2018-09-19 14:09
 **/
public class PathUtil {
	...
	private static PathSeparatorPatternCache pathSeparatorPatternCache = new PathSeparatorPatternCache
	...
	protected boolean doMatch(String pattern, String path, boolean fullMatch, Map<String, String>
